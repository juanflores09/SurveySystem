...
public class CourseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String destino = request.getParameter("menuCourse");
        String acceso = "";
        switch(destino){
            case "menuCourse": acceso = "Estudiante/MenuCourse.jsp";break;
        }
        
        RequestDispatcher destino1 = request.getRequestDispatcher(acceso);
